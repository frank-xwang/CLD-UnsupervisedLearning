...
class BaseOptions(object):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--head', default='linear', type=str,
                            choices=['linear', 'mlp', 'normmlp'], help='projection head')
    ...
    def override_options(self, opt):
        ...
        if opt.method in self.override_dict.keys():
            ...
            opt.head = opt.head if 'norm' in opt.head else self.override_dict[opt.method][4]
