...
def get_dataloader(args):
    ...
    if args.dataset == 'cifar10':
        trainset = datasets.CIFAR10Instance(root='./data/CIFAR-10', train=True, download=True, transform=transform_train, two_imgs=args.two_imgs)
        ...
        trainset = datasets.CIFAR100Instance(root='./data/CIFAR-100', train=True, download=True, transform=transform_train, two_imgs=args.two_imgs)
        train_sampler = torch.utils.data.distributed.DistributedSampler(trainset)
        trainloader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers, pin_memory=False, sampler=train_sampler)
        ...
        trainset = datasets.STL10(root='./data/STL10', split='train', download=True, transform=transform_train, two_imgs=args.two_imgs)
        train_sampler = torch.utils.data.distributed.DistributedSampler(trainset)
        trainloader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers, pin_memory=False, sampler=train_sampler)
        ...
        trainset = datasets.STL10(root='./data/STL10', split='train+unlabeled', download=True, transform=transform_train, two_imgs=args.two_imgs)
        train_sampler = torch.utils.data.distributed.DistributedSampler(trainset)
        ...
        trainset = datasets.CIFARImageFolder(root='./data/Kitchen-HC/train', train=True, transform=transform_train, two_imgs=args.two_imgs)
